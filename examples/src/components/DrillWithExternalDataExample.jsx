                        ...
                        {state && (
                            <span>
                                ...
                                <button
                                    ...
                                    className="button gd-button-primary button-small button-icon-only icon-cross s-employee-heading-clear-state"
                                />
                            </span>
                        )}
                        {location && (
                            <span>
                                ...
                                <button
                                    ...
                                    className="button gd-button-primary button-small button-icon-only icon-cross s-employee-heading-clear-location"
                                />
                            </span>
                        )}
                    </h3>
                    ...
                    <h3>
                        ...
                        {state && (
                            <span>
                                ...
                                <button
                                    onClick={this.onStateClear}
                                    className="button gd-button-primary button-small button-icon-only icon-cross s-sales-heading-clear-state"
                                />
                            </span>
                        )}
                        {location && (
                            <span>
                                ...
                                <button
                                    onClick={this.onLocationClear}
                                    className="button gd-button-primary button-small button-icon-only icon-cross s-sales-heading-clear-location"
                                />
                            </span>
                        )}
                    </h3>
