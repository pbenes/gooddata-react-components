                ...
                <div className="presets">
                    ...
                    {Object.keys(bucketPresets).map(presetItemKey => {
                        ...
                        return (
                            <ElementWithParam
                                key={key}
                                className={`preset-option button gd-button-secondary s-bucket-preset-${key} ${
                ...
                <div className="presets">
                    ...
                    {Object.keys(filterPresets).map(presetItemKey => {
                        ...
                        return (
                            <ElementWithParam
                                key={key}
                                className={`preset-option button gd-button-secondary s-drilling-preset-${key} ${
                ...
                <div className="presets">
                    ...
                    {Object.keys(sortingPresets).map(presetItemKey => {
                        ...
                        return (
                            <ElementWithParam
                                key={key}
                                className={`preset-option button gd-button-secondary s-sorting-preset-${key} ${
                ...
                <div className="presets">
                    ...
                    {Object.keys(totalPresets).map(presetItemKey => {
                        ...
                        return (
                            <ElementWithParam
                                key={key}
                                className={`preset-option button gd-button-secondary s-total-preset-${key} ${
                ...
                <div className="presets">
                    ...
                    {Object.keys(maxHeightPresets).map(presetItemKey => {
                        ...
                        return (
                            <ElementWithParam
                                key={key}
                                className={`preset-option button gd-button-secondary s-max-height-preset-${key} ${
                ...
                <div className="presets">
                    ...
                    {Object.keys(groupRowsPresets).map(presetItemKey => {
                        ...
                        return (
                            <ElementWithParam
                                key={key}
                                className={`preset-option button gd-button-secondary s-group-rows-preset-${key} ${
