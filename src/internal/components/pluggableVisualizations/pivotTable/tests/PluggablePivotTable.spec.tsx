...
import { CoreComponents, IDrillableItem } from "../../index";
...
describe("PluggablePivotTable", () => {
    ...
    describe("update", () => {
        ...
        it("should render PivotTable passing down all the necessary properties", () => {
            ...
            expect(createElementSpy.mock.calls[0][0]).toBe(CoreComponents.PivotTable);

            const defaultConfig = { menu: { aggregations: true } };
            const props = createElementSpy.mock.calls[0][1];
            ...
            expect(props.groupRows).toEqual(false);

            spyOnCleanup(renderSpy, createElementSpy);
        });

        it("should render PivotTable with enabled grouping", () => {
            const pivotTable = createComponent({
                ...defaultProps,
                featureFlags: {
            ...
            const props = createElementSpy.mock.calls[0][1];
            expect(props.groupRows).toEqual(true);
    ...
    describe("getExtendedReferencePoint", () => {
        ...
        it("should return a new reference point with totals", () => {
            ...
            return pivotTable
                .getExtendedReferencePoint(referencePointMocks.tableTotalsReferencePoint)
