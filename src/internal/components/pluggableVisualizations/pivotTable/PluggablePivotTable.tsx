...
const { PivotTable } = CoreComponents;
            ...
            produce<IExtendedReferencePoint>(
                ...
                referencePointDraft => {
                    ...
                    const previousTotals = previousReferencePoint
                        ...
                        : [];
                    const totalsUpdated = updateTotals({
                        totals,
                        previousTotals,
                        measures,
                        rowAttributes,
    ...
    protected renderVisualization(
        ...
        if (dataSource) {
            ...
            if (this.environment !== "dashboards") {
                ...
                configUpdated = merge({ menu: { aggregations: true } }, configUpdated);
            }
            ...
            const pivotTableProps = {
                ...
                intl: this.intl,
                groupRows: this.featureFlags.enablePivotGrouping === true,
            };
