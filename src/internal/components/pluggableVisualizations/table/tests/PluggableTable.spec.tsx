...
describe("PluggableTable", () => {
    ...
    describe("update", () => {
        ...
        it("should render Table and pass down all the necessary properties", () => {
            ...
            expect(createElementSpy).toHaveBeenCalledWith(CoreComponents.Table, {
                projectId: "PROJECTID",
        ...
        it("should pass correctly expanded totals in resultSpec through update", () => {
            ...
            const totalsProp = createElementSpy.mock.calls[0][1].totals;
            expect(totalsProp).toEqual(testMocks.mdObjectWithTotals.buckets[1].totals);

            const resultSpecProp: AFM.IResultSpec = createElementSpy.mock.calls[0][1].resultSpec;
