...
import { DATE_DATASET_ATTRIBUTE, ATTRIBUTE, DATE, METRIC, BUCKETS } from "../constants/bucket";
...
export function getStackItems(buckets: IBucket[]): IBucketItem[] {
    const preferredStacks = getPreferredBucket(
        buckets,
